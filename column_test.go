...
func TestColumnDeclaration(t *testing.T) {
	...
	mssqlPlatfrom := GetPlatform(MSSQL)
	...
	assertStringEquals(t, "id INT NOT NULL IDENTITY(1,1)", mssqlPlatfrom.BuildColumnDeclarationSQL(&id))
	...
	assertStringEquals(t, "name TEXT NOT NULL", mssqlPlatfrom.BuildColumnDeclarationSQL(&name))
	...
	assertStringEquals(t, "age INT", mssqlPlatfrom.BuildColumnDeclarationSQL(&age))
	...
	assertStringEquals(t, "age INT DEFAULT 10", mssqlPlatfrom.BuildColumnDeclarationSQL(&age))
	...
	assertStringEquals(t, "age INT DEFAULT 10 CHECK (age < 150)", mssqlPlatfrom.BuildColumnDeclarationSQL(&age))
