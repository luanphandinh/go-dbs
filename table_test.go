...
`CREATE TABLE IF NOT EXISTS user (
	...
	name TEXT NOT NULL,
	age INT(4) DEFAULT 10 CHECK (age < 1000) COMMENT 'age should less than 1000', PRIMARY KEY (id), CHECK (age > 50)
)`,
...
`CREATE TABLE IF NOT EXISTS user (
	id INTEGER NOT NULL,
	name TEXT NOT NULL,
	age INTEGER(4) CHECK (age < 1000) DEFAULT 10, PRIMARY KEY (id), CHECK (age > 50)
)`,
...
`CREATE TABLE IF NOT EXISTS public.user (
	id INT NOT NULL,
	name TEXT NOT NULL,
	age INT DEFAULT 10 CHECK (age < 1000), PRIMARY KEY (id), CHECK (age > 50)
);
